...
class SubmittedTimeSheetCard extends StatelessWidget {
  final SubmittedShiftUiModel item;
  final VoidCallback onClick;

  const SubmittedTimeSheetCard({super.key, required this.item, required this.onClick});
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const Spacer(),
                          TimeSheetCardButton(onPressed: () => {}, text: 'View Details'),
                        ],
                      ),
                      SizedBox(height: 12.h),
                      ...
                      Row(
                        ...
                        children: [
                          SvgIcon(assetPath: AppIcons.infoAlertRoundedBlue, size: 16.w),
                          SizedBox(width: 6.w),
                          Text(
