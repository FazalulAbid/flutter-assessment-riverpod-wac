...
class UnattendedTimeSheetCard extends StatelessWidget {
  final UnattendedTimesheetUiModel item;
  final VoidCallback onToggle;

  const UnattendedTimeSheetCard({
    super.key,
    required this.item,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      TimeSheetCardButton(onPressed: () => {}, text: 'Confirm'),
                    ],
                  ),
                ],
              ),
